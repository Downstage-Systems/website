...
(function () {
  ...
  function status() {
    return {
      ...
      portal: { detected: false, internet: true },
      ...
      satellite: { installed: true, running: false, enabled: false, ip: '',
                   install_state: 'idle', version: '2.1.0' },
  ...
  const routes = {
    ...
    '/power/ack': () => ({ ok: true }),
    '/satellite/status': () => ({ installed: true, running: false, enabled: false, ip: '',
                                  install_state: 'idle', version: '2.1.0' }),
